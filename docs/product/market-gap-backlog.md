...
|---|---|---|---|
| Operational TMS | Strong order -> billing core | AXELOT, 1C:TMS, Saby TMS | Final UAT and release evidence; * order splitting / partial shipment model |
...
| Finance | Tariffs, invoices, acts, KPI, export | 1C:TMS, AXELOT | Deeper reconciliation, claims/penalties, and accounting integrations |
| Route Optimization | Dispatching and distance foundation | Yandex Routing, ANTOR | VRP solver, traffic, multi-warehouse, time windows; * vehicle/cargo compatibility matrix |
...
| ETRN / EPD | Internal foundation and XML/export | Saby, Kontur, Taxcom | Accredited operator, KEP/MChD, GIS EPD, QR, roaming; * document dossier enforcement |
