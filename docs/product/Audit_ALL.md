...
**⚠️ 2026-05-28 ПОЛНЫЙ АУДИТ КОДА:** см. `docs/product/full-audit-2026-05-28.md` (7 параллельных
агентов). Найдено 8×P0 (cross-tenant IDOR счетов S1, утечка Telegram-уведомлений S2, copilot-leak S3,
нулевой НДС на СФ F1, journal-drift, битый T01 ЭТрН, дырявые субподряд-гейты, carrier=env) + ~20 P1.
**Часть P0 — регрессии свежего W4 (T-16) и уже в проде.** ✅ **ВСЕ 8×P0 ЗАКРЫТЫ** (2026-05-28):
S1/F1 `5f9da19`, S3 `5d37598`, C1+C2+C3 `32da51d`, S2 (+миграция 0038) `1d2651f`, INFRA1 `4387582`.
P1/P2 остаются в бэклоге (см. full-audit). ↓ детали ниже по разделам.
