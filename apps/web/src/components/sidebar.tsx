                ...
                <Link href="/" className="flex items-center gap-3 min-w-0 flex-1 hover:opacity-90">
                    ...
                    {!collapsed && (
                        <div className="min-w-0">
                            <div className="font-bold text-lg text-slate-900 leading-none">TMS</div>
                            <div className="text-[10px] font-medium text-slate-400 uppercase tracking-wider mt-0.5">Управление</div>
                        </div>
                    )}
                </Link>
                <button
