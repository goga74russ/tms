...
function repairLegacyText(value: string) {
    ...
    const legacyMap: Record<string, string> = {
        'Ñ‚ÐµÐ½Ñ‚': 'тент',
        'Ð±Ð¾Ñ€Ñ‚': 'борт',
        'Ñ€ÐµÑ„Ñ€Ð¸Ð¶ÐµÑ€Ð°Ñ‚Ð¾Ñ€': 'рефрижератор',
        'Ñ„ÑƒÑ€Ð³Ð¾Ð½': 'фургон',
        'Ñ†Ð¸ÑÑ‚ÐµÑ€Ð½Ð°': 'цистерна',
        'ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð¾Ð²Ð¾Ð·': 'контейнеровоз',
        'ÑÐ°Ð¼Ð¾ÑÐ²Ð°Ð»': 'самосвал',
        'ÑÐµÐ´Ð°Ð½': 'седан',
        'ÑƒÐ½Ð¸Ð²ÐµÑ€ÑÐ°Ð»': 'универсал',
        'ÐºÑ€Ð¾ÑÑÐ¾Ð²ÐµÑ€': 'кроссовер',
        'Ð¼Ð¸Ð½Ð¸Ð²ÑÐ½': 'минивэн',
        'ÑÐ¿ÐµÑ†Ñ‚ÐµÑ…Ð½Ð¸ÐºÐ°': 'спецтехника',
        'ÑÐ²Ð°ÐºÑƒÐ°Ñ‚Ð¾Ñ€': 'эвакуатор',
        'Ð¼Ð°Ð½Ð¸Ð¿ÑƒÐ»ÑÑ‚Ð¾Ñ€': 'манипулятор',
        'ÐºÑ€Ð°Ð½': 'кран',
        'Ð¿Ð¾Ð»ÑƒÐ¿Ñ€Ð¸Ñ†ÐµÐ¿': 'полуприцеп',
        'other': 'other',
    };
...
export function getVehicleWaybillCue(
    ...
    const isLight = profile.classLabel === 'Р›РµРіРєРѕРІРѕР№';
    const isSpecial = profile.classLabel === 'РЎРїРµС†С‚РµС…РЅРёРєР°';
    const hasTrailer = Boolean(options?.trailerPlate);
