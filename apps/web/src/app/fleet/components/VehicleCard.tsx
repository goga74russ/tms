                ...
                {activeSection === 'info' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3 text-sm">
                                ...
                                <div className="col-span-2">
                                    <span className="text-slate-500">Прицеп:</span>{' '}
                        ...
                        <div className="rounded-xl border border-indigo-100 bg-indigo-50/60 px-4 py-3">
                            ...
                            <p className="text-sm font-semibold text-slate-800">{vehicleProfile.displayLabel}</p>
                            <p className="mt-1 text-[11px] text-slate-500">{waybillCue.profileLabel}</p>
                        </div>
                        ...
                        <div className="mt-2 flex flex-wrap gap-2">
                            <span className="inline-flex rounded-full bg-white px-2.5 py-1 text-[11px] font-semibold text-slate-700 shadow-sm">
