...
const PLANS: Plan[] = [
    ...
    },
    {
        ...
        features: [
            'До 30 машин',
            'Безлимит заказов',
            'ИИ-копилот: 500 запросов/день (скоро)',
            'Подключение к ЭДО (скоро): Диадок, СБИС, Калуга, Такском',
    ...
    },
    {
        ...
        features: [
            'До 100 машин',
            'Безлимит заказов',
            'ИИ-копилот: 2 000 запросов/день (скоро)',
            'Wialon live (скоро), тахограф DDD',
