...
const FEATURES: Feature[] = [
    ...
    },
    {
        ...
        desc: 'Offline-режим (WatermelonDB), осмотры, чекпоинты, фотофиксация документов прямо в смене.',
        tone: 'warning',
    },
    {
        icon: Thermometer,
    ...
    },
    {
        ...
        desc: 'Экспорт в 1С, маркировка «Честный знак», ОСАГО-мониторинг. Оператор ЭДО — Диадок (на подключении), остальные в дорожной карте.',
        tone: 'neutral',
    },
    {
        icon: Lock,
