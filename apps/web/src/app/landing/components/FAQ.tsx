...
const QUESTIONS: Array<{ q: string; a: string }> = [
    ...
    },
    {
        ...
        a: 'Да. Cold chain SLA — нативная функция: контроль температуры в пути, алерты при выходе за коридор, журнал нарушений с привязкой к рейсу и водителю. Логирование с мобильного приложения и интеграция с термодатчиками.',
    },
    {
