...
const QUESTIONS: Array<{ q: string; a: string }> = [
    ...
    {
        // TODO(/marketing §4.3): финальный ответ про конкурентов готов в
        // docs/tasks/marketing/2026-06-16-competitor-faq-finalize.md (status done) —
        // подменить ЭТУ заглушку перед merge ПОСЛЕ Jurist-ревью упоминания брендов
        // (бриф §10, ст. 5 ч. 2 ФЗ-38). Заглушка нейтральна, без цен конкурентов.
        q: 'Чем отличаетесь от 1С:ТМС, СБИС TMS, Умной Логистики?',
        a: 'ТрансПульт — для небольшого парка (2–30 машин), с запуском без интегратора и фокусом на готовности к ЭТрН-2026. Подробное сравнение по публичным тарифам готовим — напишите на sales@transpult.ru, пришлём актуальный разбор под ваш парк.',
    },
    {
