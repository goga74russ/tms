...
const QUESTIONS: Array<{ q: string; a: string }> = [
    ...
    },
    {
        ...
        a: 'В бесплатном режиме можно работать без неё — координаты вводятся вручную или загружаются CSV. Live-интеграция Wialon (автоматический GPS-трекинг, ETA, алерты отклонения от маршрута) появится на тарифе Business.',
    },
    {
