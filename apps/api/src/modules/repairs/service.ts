...
function buildRepairPartsSummary(parts: RepairPart[], totalCost?: number | string | null): RepairPartsSummary {
...
function validateRepairParts(parts: RepairPart[]) {
...
function assertTransitionReadiness(repair: any, newStatus: string) {
