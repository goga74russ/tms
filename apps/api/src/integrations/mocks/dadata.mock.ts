...
// ============================================================
// TODO(wave6): этот модуль — имитатор для бесплатного режима.
// При переходе на платный тариф DaData (suggest.dadata.ru) заменить
// на HTTP-клиент к DaData REST API; интерфейсы DaDataCompany/Address
// сохранить как контракт для остальных модулей.
// ============================================================
