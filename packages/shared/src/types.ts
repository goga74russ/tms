...
export type {
    ...
    TransportDocument, TransportDocumentHistoryEvent, TransportDocumentExchange, TransportDocumentReceipt, TransportDocumentExchangeState, TransportDocumentTimelineEvent, TransportDocumentProblem,
    TransportDocumentSummary, TransportDocumentLifecycle, TransportDocumentBundle, TransportDocumentListResponse,
    EtrnTitle, EtrnTimelineEvent, EtrnWorkflowSummary, EtrnWorkflow,
...
export type {
    ...
    TariffType, EpdDocumentType, TransportDocumentType, TransportDocumentStatus, TransportDocumentExchangeStatus, TransportDocumentExchangeDirection, TransportDocumentReceiptType, EventType,
